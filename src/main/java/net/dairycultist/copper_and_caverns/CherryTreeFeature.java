...
public class CherryTreeFeature extends Feature {

    @Override
    public boolean generate(World world, Random random, int x, int y, int z) {

        // just stole this from OakTreeFeature for now
                ...
                if ((var8 == Block.GRASS_BLOCK.id || var8 == Block.DIRT.id) && y < 128 - var6 - 1) {
                        ...
                        for(var12 = x - var11; var12 <= x + var11; ++var12) {
                            ...
                            for(int var14 = z - var11; var14 <= z + var11; ++var14) {
                                ...
                                if ((Math.abs(var13) != var11 || Math.abs(var15) != var11 || random.nextInt(2) != 0 && var10 != 0) && !Block.BLOCKS_OPAQUE[world.getBlockId(var12, var9, var14)]) {
                                    world.setBlockWithoutNotifyingNeighbors(var12, var9, var14, Block.LEAVES.id, 3);
                                }
                            }
                        }
                    }
                    ...
                    for(var9 = 0; var9 < var6; ++var9) {
                        ...
                        if (var10 == 0 || var10 == Block.LEAVES.id) {
                            world.setBlockWithoutNotifyingNeighbors(x, y + var9, z, Block.LOG.id, 3);
                        }
                    }
